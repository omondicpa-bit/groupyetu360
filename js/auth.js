...
let allMembers = [];
let allContribTypes = [];
let _lastFinanceData = { txns: [], incomes: [], expenses: [] }; // cached by loadFinance() so export buttons don't need a separate re-fetch
let _lastMemberDetail = null; // cached by openMemberDetail() for the print statement
let _lastMemberHistory = []; // cached by loadMemberHistory() for the print statement
let allProjects = [];
