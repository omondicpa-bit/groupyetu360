// GroupYetu360 Service Worker v5.6 — groupyetu.org
const CACHE_NAME = 'gy360-v5.6';
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/manifest.json',
...
self.addEventListener('install', event => {
  console.log('[GY360 SW] Installing v5.6');
  event.waitUntil(
...
self.addEventListener('activate', event => {
  console.log('[GY360 SW] Activating v5.6 — clearing old caches');
  event.waitUntil(
