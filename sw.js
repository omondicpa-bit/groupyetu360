// GroupYetu360 Service Worker v5.16 — groupyetu.org
const CACHE_NAME = 'gy360-v5.16';
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/manifest.json',
...
self.addEventListener('install', event => {
  console.log('[GY360 SW] Installing v5.16');
  event.waitUntil(
...
self.addEventListener('activate', event => {
  console.log('[GY360 SW] Activating v5.16 — clearing old caches');
  event.waitUntil(
