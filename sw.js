// GroupYetu360 Service Worker v5.12 — groupyetu.org
const CACHE_NAME = 'gy360-v5.12';
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/manifest.json',
...
self.addEventListener('install', event => {
  console.log('[GY360 SW] Installing v5.12');
  event.waitUntil(
...
self.addEventListener('activate', event => {
  console.log('[GY360 SW] Activating v5.12 — clearing old caches');
  event.waitUntil(
