// GroupYetu360 Service Worker v5.3 — groupyetu.org
const CACHE_NAME = 'gy360-v5.3';
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/manifest.json',
...
self.addEventListener('install', event => {
  console.log('[GY360 SW] Installing v5.3');
  event.waitUntil(
...
self.addEventListener('activate', event => {
  console.log('[GY360 SW] Activating v5.3 — clearing old caches');
  event.waitUntil(
