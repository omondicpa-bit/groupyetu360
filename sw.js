// GroupYetu360 Service Worker v5.25 — groupyetu.org
const CACHE_NAME = 'gy360-v5.25';
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/manifest.json',
...
self.addEventListener('install', event => {
  console.log('[GY360 SW] Installing v5.25');
  event.waitUntil(
...
self.addEventListener('activate', event => {
  console.log('[GY360 SW] Activating v5.25 — clearing old caches');
  event.waitUntil(
