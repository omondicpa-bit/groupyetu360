// GroupYetu360 Service Worker v4.9 — groupyetu.org
const CACHE_NAME = 'gy360-v4.9';
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/manifest.json',
...
self.addEventListener('install', event => {
  console.log('[GY360 SW] Installing v4.9');
  event.waitUntil(
...
self.addEventListener('activate', event => {
  console.log('[GY360 SW] Activating v4.9 — clearing old caches');
  event.waitUntil(
